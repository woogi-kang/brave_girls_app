class YoutubeListModel {
  ...
  YoutubeListModel({this.kind, this.etag, this.nextPageToken, this.regionCode, this.pageInfo, this.items});
...
class Thumbnails {
  ...
  Thumbnails.fromJson(Map<String, dynamic> json) {
    normal = json['normal'] != null ? new Thumbnail.fromJson(json['normal']) : null;
    medium = json['medium'] != null ? new Thumbnail.fromJson(json['medium']) : null;
